...
def parse_comments_and_conditions(text: str):
    ...
    Returns two DataFrames:
      (comments_df) with RaceComment and LastStartComment
      (conditions_df) with TrackCondition, Weather, Interference
    both keyed by Box & DogName.
    """
    lines = [clean_text(x) for x in text.splitlines()]
    rows_comment: List[Dict[str, Any]] = []

...
echo ""
echo "3. Run ML training:"
echo -e "   ${BLUE}python train_ml_track_ensemble.py${NC}"
echo "   (This will train models for SALE and WENTWORTH PARK tracks)"
echo ""
echo "4. Run predictions (after training):"
...
echo "  • Models: Pre-trained models for 2 tracks"

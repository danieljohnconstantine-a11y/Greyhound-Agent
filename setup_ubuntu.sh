...
echo ""
echo "3. Run ML training (optional — trains XGB models):"
echo -e "   ${BLUE}python train_ml_track_ensemble.py${NC}"
echo "   (Trains XGB models for all tracks. RF+GB models are pre-trained.)"
echo ""
echo "4. Validate models (checks all tracks and models load correctly):"
echo -e "   ${BLUE}python validate_pipeline.py${NC}"
echo ""
echo "5. Run predictions:"
echo -e "   ${BLUE}python run_track_ensemble_predictions.py${NC}"
echo ""
echo "6. When done, deactivate virtual environment:"
...
echo "  • Models: Pre-trained RF+GB models for 3 tracks (Angle Park, BALLARAT, BENDIGO)"
echo "  • Source code: 12 Python modules"
echo ""
echo -e "${YELLOW}💡 TIPS:${NC}"
echo "  • Training takes 2-5 minutes"
echo "  • Results saved to models/ directory"
echo "  • Logs saved to logs/ directory"
echo "  • Always activate venv before running scripts"
echo ""
